...
interface StMTRGUpgradeableInterface extends ethers.utils.Interface {
  functions: {
...
export class StMTRGUpgradeable extends Contract {
  ...
  interface: StMTRGUpgradeableInterface;
