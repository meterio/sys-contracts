...
interface MockMTRGInterface extends ethers.utils.Interface {
  functions: {
...
export class MockMTRG extends Contract {
  ...
  "minter(address)"(arg0: string, overrides?: CallOverrides): Promise<boolean>;
